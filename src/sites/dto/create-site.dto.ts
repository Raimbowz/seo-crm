...
export class CreateSiteDto {
  ...
  @ApiProperty({
    example: true,
    description: 'Robots meta no index',
    required: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({
    example: '{"ru":{"metaTitle":"My Site","metaDescription":"SEO desc"}}',
    description: 'Locales',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    example: true,
    description: 'Whether localizations are enabled',
    required: false,
  })
  @IsOptional()
  @IsBoolean()
  ...
  @ApiProperty({
    example: 'ru-RU',
    description: 'Default locale when localizations disabled',
    required: false,
  })
  @IsOptional()
  @IsString()
